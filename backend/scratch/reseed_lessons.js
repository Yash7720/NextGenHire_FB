...
const CLEAN_LESSONS = [
  ...
  // ── C++ ───────────────────────────────────────────────────────────────────────
  { course: 'c++', chapter: 'CPP Basics', title: 'Syntax',
  ...
  { course: 'c++', chapter: 'CPP Basics', title: 'Data Types',
  ...
  { course: 'c++', chapter: 'CPP Basics', title: 'I/O',
  ...
  { course: 'c++', chapter: 'Pointers & Memory', title: 'Pointers',
  ...
  { course: 'c++', chapter: 'Pointers & Memory', title: 'References',
  ...
  { course: 'c++', chapter: 'Pointers & Memory', title: 'Dynamic Allocation',
  ...
  { course: 'c++', chapter: 'OOP in CPP', title: 'Classes',
  ...
  { course: 'c++', chapter: 'OOP in CPP', title: 'Constructors',
  ...
  { course: 'c++', chapter: 'OOP in CPP', title: 'Polymorphism',
  ...
  { course: 'c++', chapter: 'STL', title: 'Vectors',
  ...
  { course: 'c++', chapter: 'STL', title: 'Maps',
  ...
  { course: 'c++', chapter: 'STL', title: 'Algorithms',
  ...
  { course: 'c++', chapter: 'Templates', title: 'Function Templates',
  ...
  { course: 'c++', chapter: 'Templates', title: 'Class Templates',
  ...
  { course: 'c++', chapter: 'Templates', title: 'Metaprogramming',
  ...
  .then(async () => {
    ...
    for (const newLesson of CLEAN_LESSONS) {
      ...
      const existing = await Lesson.find({
        course: new RegExp(`^${escapeRegex(newLesson.course)}$`, 'i'),
        title:  new RegExp(`^${escapeRegex(newLesson.title)}$`,  'i'),
      });
